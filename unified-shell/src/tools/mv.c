...
int tool_mv_main(int argc, char **argv) {
    ...
    if (path_count < 2) {
        fprintf(stderr, "mv: missing destination file operand\n");
        fprintf(stderr, "Usage: ./mv [-i] SOURCE DEST\n");
        fprintf(stderr, "   or: ./mv [-i] SOURCE... DIRECTORY\n");
        return 1;
    }
